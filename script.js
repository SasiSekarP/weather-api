...
let textDiscriptionEl = document.getElementById("textDiscription");
let locationEl = document.getElementById('location');
let DatacollectedTimeEl = document.getElementById("DatacollectedTime");
let windDirectionEl = document.getElementById('windDirection');
let windSpeedEl = document.getElementById('windSpeed');
let precipitationEl = document.getElementById('precipitation');
let humidityEl = document.getElementById('humidity');
let getLocationContainerEl = document.getElementById('getLocationContainer');
...
let data = {
   location: {
      ...
      humidity: 61,
      is_day: 0,
      last_updated: "2023-01-21 19:30",
      last_updated_epoch: 1674309600,
      precip_in: 0,
      precip_mm: 0,
      pressure_in: 29.88,
      pressure_mb: 1012,
      ...
      country: "India",
      lat: 10.57,
      localtime: "2023-01-21 19:33",
      localtime_epoch: 1674309839,
      lon: 72.62,
      name: "Kavaratti",
      region: "Lakshadweep",
      tz_id: "Asia/Kolkata"
...
getLocationContainerEl.addEventListener('submit', (e) => {
   e.preventDefault();
   ...
   windSpeedEl.innerText = `: ${data.current.wind_kph}`;
   precipitationEl.innerText = `: ${data.current.precip_mm}`;
...
districtNameWithStateName.states.forEach(a => {
   districtNameList = [...districtNameList,...a.districts]
})
districtNameList.sort();

// function area

function addValueInDropDown(a) {
   let newEl = document.createElement('Option')
   LocationInputEl.appendChild(newEl);
   newEl.innerText = a;
   newEl.value = a;
}
...
districtNameList.forEach(a => {
   addValueInDropDown(a);
})
